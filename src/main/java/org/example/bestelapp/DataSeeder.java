        ...
        return args -> {
            ...
            if (productDAO.count() == 0) {
                ...
                productDAO.saveAll(List.of(
                        ...
                        new Product(0, "Kabelstripper", categories.get("Gereedschap"), 30, true, null),
                        ...
                        new Product(0, "Rioolstoppen", categories.get("Specifieke Aquafin / riolering gerelateerde tools"), 8, true, null),
                        ...
                        new Product(0, "Tie-wraps", categories.get("Diversen / Verbruiksgoederen"), 100, true, null),
